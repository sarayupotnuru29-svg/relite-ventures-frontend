...
// Ensure these paths match exactly what is in your App.tsx Routes
const navLinks = [
  { name: 'Home', path: '/' },
  { name: 'About Us', path: '/about' }, 
  { name: 'Services', path: '/services' },
      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            />
            <span className="font-display font-semibold text-primary-foreground text-sm md:text-base leading-tight">
              <span className="text-[#EAB308]">R Elite</span> Design<br className="hidden md:block" /> Ventures
            </span>
          </Link>
            ...
            <Link
              ...
              className={`text-sm py-2 px-6 rounded-full font-bold transition-all duration-300 border-2 ${
                isGetStartedActive 
                  ...
                  : 'bg-transparent border-[#EAB308] text-[#EAB308] hover:bg-[#EAB308] hover:text-white' 
              }`}
            >
              Get Started
            </Link>
