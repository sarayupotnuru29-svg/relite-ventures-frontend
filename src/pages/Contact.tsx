                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground leading-relaxed">
                      <p className="font-medium text-foreground">R ELITE DESIGN VENTURES</p>
                      <p>Opposite More Supermarket, NTR CIRCLE</p>
                      <p>Kadiri Road, Madanapalle – 517325</p>
                      <p>Andhra Pradesh</p>
                      <a 
                        href="https://jsdl.in/DT-99EVDQMQ3KD" 
                        target="_blank" 
                        rel="noopener noreferrer"
            ...
            <div className="space-y-8">
              ...
              <div className="bg-secondary rounded-lg overflow-hidden border border-border">
                <div className="aspect-video bg-muted">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15514.492040187883!2d78.49080555!3d13.558399999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bb240833a650209%3A0x8670c538a735c03e!2sMadanapalle%2C%20Andhra%20Pradesh!5e0!3m2!1sen!2sin!4v1715600000000!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    ...
                    loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade"
                    title="R Elite Design Ventures NTR Circle Location"
                    className="w-full h-full"
                  />
                </div>
                <div className="p-4 bg-card">
                  <p className="text-sm font-medium text-primary flex items-center gap-2">
                    ...
                    NTR Circle, Kadiri Road, Madanapalle
                  </p>
                </div>
              </div>
            </div>
